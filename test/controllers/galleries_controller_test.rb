...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { created_by: @gallery.created_by, date: @gallery.date, description: @gallery.description, name: @gallery.name, updated_by: @gallery.updated_by } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { created_by: @gallery.created_by, date: @gallery.date, description: @gallery.description, name: @gallery.name, updated_by: @gallery.updated_by } }
