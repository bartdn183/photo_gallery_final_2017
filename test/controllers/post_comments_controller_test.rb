...
class PostCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_comment" do
    assert_difference('PostComment.count') do
      post post_comments_url, params: { post_comment: { comment_entry: @post_comment.comment_entry, post_id: @post_comment.post_id, user_id: @post_comment.user_id } }
    end
  ...
  test "should update post_comment" do
    patch post_comment_url(@post_comment), params: { post_comment: { comment_entry: @post_comment.comment_entry, post_id: @post_comment.post_id, user_id: @post_comment.user_id } }
